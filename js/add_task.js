...
setURL('https://sezgin-guendogdu.developerakademie.net/Join-Projekt/smallest_backend_ever-master');
...
let removeClassOfPriorClickedElemIndex;
...
function changeColorSelected(i) {
    removeClassOfPriorClickedElemIndex = i;
...
let saveIndexForEditingCategory;
...
function changeDateToToday() {
    ...
    inputField.setAttribute('min', today.toISOString().substring(0, 10));   
